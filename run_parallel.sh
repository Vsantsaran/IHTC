...
INPUT_DIR="../data/train"         # input folder
OUTPUT_DIR="../output/oanga/train" # solution folder
LOG_DIR="../logs/oanga"           # logs folder
TOTAL_RUNS=30                     # number of input files
...
for ((i=1; i<=TOTAL_RUNS; i++)); do
    ...
    INPUT_FILE="${INPUT_DIR}/i${num}.json"
    OUTPUT_FILE="${OUTPUT_DIR}/sol_tr_ga${num}.json"
