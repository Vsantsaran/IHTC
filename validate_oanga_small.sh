...
OUTPUT_DIR="output/oanga/small"
LOG_DIR="validate_results/oanga/small"
...
for ((i=$START; i<=$END; i++)); do
    ...
    input_file="${INPUT_DIR}/small${padded_num}.json"
    output_file="${OUTPUT_DIR}/sol_sm_ga${i}.json"
    log_file="${LOG_DIR}/log${padded_num}.txt"

    echo "[Small ${padded_num}] Processing: $input_file -> $output_file"
